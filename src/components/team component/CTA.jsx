...
export default function CTA(){
    return (
                ...
                <div className="md:w-3/4 mx-auto flex flex-col gap-4 my-10 bg-[#FAF8F8] backdrop-blur-md shadow-lg border-[1px] border-blue-950/20 rounded-xl p-5">
                    ...
                    <a href="/contact" className="font-bold border border-blue-900/40 m-auto w-full md:w-fit text-center rounded-md p-2 px-15 border-slate-950/20 text-blue-950">Talk to Us</a>
                </div>
