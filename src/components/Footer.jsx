                             ...
                             <h3 className="font-medium mb-2">GET IN TOUCH</h3>
                               <address className="flex flex-col items-start gap-3">
                                  ...
                                  <span className="group flex flex-row items-center gap-2 font-normal "> 
                                    ...
                                    <a href="" className="font-semibold text-sm text-gray-500 group-hover:text-red-900/70 transition-all duration-500 not-italic"> +265 88 155 0810</a>
                                  </span>
                                  <span  className="group flex flex-row  flex-wrap items-center gap-2 font-normal "> 
                                    ...
                                    <a href="" className="font-semibold text-gray-500 text-sm group-hover:text-red-900/70 not-italic transition-all duration-500">flexconsultancy@gmail.com</a> 
                                  </span>
                                </address>
                               </article>
                             </div>
