...
export default function Industrial(){
           return(
                  <section className="max-w-6xl lg:max-w-7xl lg:px-5 mx-5 md:mx-auto  text-center text-zinc-500 mb-10">
                          <h4 className="text-2xl text-zinc-50 font-bold  pb-7">Commercial Properties</h4>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <article className="flex flex-col gap-2 justify-between bg-zinc-100/5 border-b border-zinc-800/50 py-1 text-justify ">
                              
                                <img src={residential} className="w-full object-cover h-40 "/>
                                  <h4 className="text-left font-medium text-zinc-800">Office Block</h4>
                            ...
                            <article className="flex flex-col gap-2 justify-between bg-zinc-100/5 shadow-sm shadow-stone-300  p-2 text-justify">
